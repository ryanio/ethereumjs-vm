...
_Defined in [types.ts:19](https://github.com/ethereumjs/ethereumjs-vm/blob/2347a51/packages/tx/src/types.ts#L19)_
...
_Defined in [types.ts:14](https://github.com/ethereumjs/ethereumjs-vm/blob/2347a51/packages/tx/src/types.ts#L14)_
